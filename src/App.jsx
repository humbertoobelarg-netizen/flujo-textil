            ...
            {adminTab === "pedidos" && (
              <div>
                ...
                {[...pedidosFiltrados].sort((a,b)=>(a.fecha_entrega||"9999").localeCompare(b.fecha_entrega||"9999")).map(p => (
                  <PedidoCardAdmin key={p.id} p={p} usuario={usuario} usuarios={usuarios} pedidos={pedidos} setPedidos={setPedidos}
                    eliminarPedido={eliminarPedido} setEditandoPedido={setEditandoPedido} setFormEditar={setFormEditar}
                    setSelectedPedido={setSelectedPedido} setShowAgregado={setShowAgregado} setFormAgregado={setFormAgregado} PRENDA_INIT={PRENDA_INIT}
                    showPagos={showPagos} setShowPagos={setShowPagos} nuevoPago={nuevoPago} setNuevoPago={setNuevoPago} agregarPago={agregarPago}
                    puedeVerPrecios={puedeVerPrecios} puedeVerTejido={puedeVerTejido}
                  />
                ))}
