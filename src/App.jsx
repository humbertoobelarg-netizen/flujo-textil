...
export default function App() {
  ...
  async function crearPedido() {
    ...
    setFormPedido({ cliente:"", cantidad:"", prioridad:"media", fechaEntrega:"", descripcion:"", procesosActivos:["orden","terminacion"], tipoPrenda:"", tipoTejido:"", molderia:"", talles:{}, cuerpo:"", manga:"", color:"", puno:"", cuello:"", colorCuello:"", imagenes:[] });
                  ...
                  <div key={pedidoActual.id} className="card fade" style={{ marginBottom:12,overflow:"hidden",borderLeft:`4px solid ${etapa==="listo"?"#10b981":etapa==="en_proceso"?"#f59e0b":pri?.color}` }}>
                    <div style={{ padding:"14px 16px" }}>
                      ...
                      <div style={{ marginBottom:10,display:"grid",gridTemplateColumns:"1fr 1fr",gap:6 }}>
                        {pedidoActual.tipo_prenda && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>TIPO DE PRENDA</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.tipo_prenda}</div>
                        </div>}
                        {pedidoActual.tipo_tejido && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>TIPO DE TEJIDO</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.tipo_tejido}</div>
                        </div>}
                        {pedidoActual.molderia && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>MOLDERÍA</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.molderia}</div>
                        </div>}
                        {pedidoActual.cuerpo && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>CUERPO COLOR</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.cuerpo}</div>
                        </div>}
                        {pedidoActual.manga && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>MANGA TIPO</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.manga}</div>
                        </div>}
                        {pedidoActual.color && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>MANGA COLOR</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.color}</div>
                        </div>}
                        {pedidoActual.puno && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>PUÑO</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.puno}</div>
                        </div>}
                        {pedidoActual.cuello && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>CUELLO TIPO</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.cuello}</div>
                        </div>}
                        {pedidoActual.color_cuello && <div style={{ padding:"6px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:9,color:"#8a7a6a",letterSpacing:1 }}>COLOR CUELLO</div>
                          <div style={{ fontSize:12,fontWeight:500 }}>{pedidoActual.color_cuello}</div>
                        </div>}
                      </div>
                      ...
                      {(pedidoActual.imagenes_urls||[]).length > 0 && (
                        <div style={{ marginBottom:10,padding:"8px 10px",background:"#f5f0e8" }}>
                          <div style={{ fontSize:10,color:"#8a7a6a",letterSpacing:1,marginBottom:8 }}>IMÁGENES DEL DISEÑO</div>
                    ...
                    <div key={p.id} className="card fade" style={{ marginBottom:10,overflow:"hidden",cursor:"pointer",borderLeft:`4px solid ${pri?.color}` }} onClick={() => setSelectedPedido(open?null:p)}>
                      ...
                      {open && (
                        <div style={{ padding:"0 18px 16px",borderTop:"1.5px solid #e8e0d0" }} onClick={e=>e.stopPropagation()}>
                          ...
                          {p.molderia && <div style={{ marginTop:6,padding:"8px 12px",background:"#f5f0e8" }}>
                            <div style={{ fontSize:10,color:"#8a7a6a",letterSpacing:1,marginBottom:2 }}>MOLDERÍA</div>
                            <div style={{ fontSize:13 }}>{p.molderia}</div>
                          </div>}
