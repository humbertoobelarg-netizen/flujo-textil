              ...
              return grupos.map(grupo => grupo.items.length === 0 ? null : (
                <div key={grupo.titulo} style={{ marginBottom:20 }}>
                  ...
                  {grupo.items.map(p => {
                    ...
                    return (
                      <div key={pedidoActual.id} className="card fade" style={{ marginBottom:12,overflow:"hidden",borderLeft:`4px solid ${etapa==="listo"?"#10b981":etapa==="en_proceso"?"#f59e0b":pri?.color}`, background: etapa==="pendiente"?"#fff0f0":"#f0fff4" }}>
                        <div style={{ padding:"14px 16px" }}>
          ...
          <div className="modal" onClick={e=>e.stopPropagation()}>
            ...
            <div style={{ padding:24,display:"flex",flexDirection:"column",gap:14 }}>
              ...
              {calcTotalGral(formAgregado.prendas) > 0 && (
                <div>
                  <ResumenPrecios prendas={formAgregado.prendas} anticipo={formAgregado.anticipo} />
