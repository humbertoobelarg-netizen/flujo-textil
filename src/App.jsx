...
export default function App() {
  ...
  async function crearPedido() {
    ...
    setFormPedido({ cliente:"", cantidad:"", prioridad:"media", fechaEntrega:"", descripcion:"", procesosActivos:["orden","terminacion"], tipoPrenda:"", tipoTejido:"", talles:{}, cuerpo:"", manga:"", color:"", puno:"", cuello:"", colorCuello:"" });
          ...
          <div className="modal" onClick={e=>e.stopPropagation()}>
            ...
            <div style={{ padding:24,display:"flex",flexDirection:"column",gap:14 }}>
              ...
              <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:12 }}>
                <div>
                  <label style={{ fontSize:10,letterSpacing:1,color:"#8a7a6a",display:"block",marginBottom:5 }}>CUERPO *</label>
                  <input type="text" style={{ width:"100%" }} placeholder="Cuerpo..." value={formPedido.cuerpo||""} onChange={e=>setFormPedido({...formPedido,cuerpo:e.target.value})} />
                </div>
                <div>
                  <label style={{ fontSize:10,letterSpacing:1,color:"#8a7a6a",display:"block",marginBottom:5 }}>MANGA *</label>
                  <input type="text" style={{ width:"100%" }} placeholder="Manga..." value={formPedido.manga||""} onChange={e=>setFormPedido({...formPedido,manga:e.target.value})} />
                </div>
                <div>
                  <label style={{ fontSize:10,letterSpacing:1,color:"#8a7a6a",display:"block",marginBottom:5 }}>COLOR *</label>
                  <input type="text" style={{ width:"100%" }} placeholder="Color..." value={formPedido.color||""} onChange={e=>setFormPedido({...formPedido,color:e.target.value})} />
                </div>
                <div>
                ...
                <div>
                  <label style={{ fontSize:10,letterSpacing:1,color:"#8a7a6a",display:"block",marginBottom:5 }}>CUELLO *</label>
                  <input type="text" style={{ width:"100%" }} placeholder="Cuello..." value={formPedido.cuello||""} onChange={e=>setFormPedido({...formPedido,cuello:e.target.value})} />
                </div>
                <div>
